...
for src in $(cd external/jnihook/src && ls *.cpp); do
	cc -o "build/$src.o" -g -ggdb -c -fPIC "external/jnihook/src/$src" -I external/jnihook/include -I "$JAVA_HOME/include" -I "$JAVA_HOME/include/linux"
done
cc -o build/main.o -g -ggdb -c -fPIC src/main.cpp -I external/jnihook/include -I "$JAVA_HOME/include" -I "$JAVA_HOME/include/linux"
